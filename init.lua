-- NOTE: basic vim opts before lazy
...
--  For more options, you can see `:help option-list` Make line numbers default
vim.opt.number = true
...
vim.opt.foldminlines = 6 -- minimum number of lines a foldable element needs to be to fold.
